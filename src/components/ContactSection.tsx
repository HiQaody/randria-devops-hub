          ...
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                variant="outline" 
                size="lg"
                onClick={() => window.location.href = "https://calendly.com/jacquinot-randrianomenjanahary/30min"}
              ...
              <Button 
                variant="outline" 
                size="lg"
                onClick={() => window.location.href = "mailto:randrianomenjanaharyjacquinot@gmail.com"}
                className="border-white text-primary hover:bg-white hover:text-primary"
              >
